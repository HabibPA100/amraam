...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Amraam", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("Amraam", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Amraam";
		app.meta["name"] = "Amraam";
